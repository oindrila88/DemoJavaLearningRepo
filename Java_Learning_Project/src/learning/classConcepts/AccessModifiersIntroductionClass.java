...
public class AccessModifiersIntroductionClass
{
	...
	//1. Access Modifiers - The Access Modifiers in Java specifies the "Accessibility" or "Scope" of a Field, Method, Constructor or Class. The "Access Level" of Fields, Methods, Constructors or Classes can be changed by applying the Access Modifiers on those. There are 4 types of Access Modifiers in Java. These are -
